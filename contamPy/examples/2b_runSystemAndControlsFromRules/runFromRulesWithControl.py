...
controlsDirectory = os.path.join(ressourcesDir,'controls')


caseConfig = caseConfigurator(refBuildingsDir,occupancyDir,weatherDir,libraryDir,contaminantsDir,namedSystemsDirectory,controlsDirectory)
...
caseConfig.writeCurrentJSON('MEV-RIJ2-namedSystemWithControls.json')

caseConfig.writeContamFile('MEV-RIJ2-namedSystemWithControls.prj')



# Run an existing PRJ file
contam = contamRunner(contamDir)    
contam.runContam('MEV-RIJ2-namedSystemWithControls.prj')
