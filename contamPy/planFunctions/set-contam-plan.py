...
rootwithpath=fname.replace('.prj','')
...
contam_functions.writecontamfile(fname,os.path.join(setdir,root)+'.prj',contam_data)
    

print("File ",fname," with areas generated")
